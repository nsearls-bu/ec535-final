...
float *load_audio_and_resample(char *file_path)
{
    SF_INFO info;
    info.format = 0;
...
int main(int argc, char **argv)
{
    ...
    float *audio_buffer = load_audio_and_resample(argv[1]);
