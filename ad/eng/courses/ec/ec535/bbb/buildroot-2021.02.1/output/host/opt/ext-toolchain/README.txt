...
libffi       3.3                  MIT
libzlib      1.2.11               Zlib
gdb          8.3.1                GPL-2.0+, LGPL-2.0+, GPL-3.0+, LGPL-3.0+
libiberty    2.32                 LGPL-2.1+
...
For those who would like to reproduce the toolchain, you can just follow these steps:
    ...
    curl http://toolchains.bootlin.com/downloads/releases/toolchains/armv7-eabihf/build_fragments/armv7-eabihf--glibc--stable-2020.08-1.defconfig > .config
    make olddefconfig
    make
