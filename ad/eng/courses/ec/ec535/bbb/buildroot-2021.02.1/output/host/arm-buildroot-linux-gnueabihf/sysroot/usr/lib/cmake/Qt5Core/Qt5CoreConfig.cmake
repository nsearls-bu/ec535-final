...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/qt5/QtCore/5.15.2"
        "${_qt5Core_install_prefix}/include/qt5/QtCore/5.15.2/QtCore"
    )
    ...
    set_property(TARGET Qt5::Core
                 ...
                 clock-gettime;datetimeparser;doubleconversion;futimens;getauxval;getentropy;glibc;hijricalendar;inotify;linkat;mimetype-database;poll_ppoll;system-pcre2;renameat2;sha3-fast;statx)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 etw;futimes;glib;gnu-libiconv;iconv;icu;journald;lttng;poll_poll;poll_pollts;poll_select;posix-libiconv;slog2;syslog;system-doubleconversion)
